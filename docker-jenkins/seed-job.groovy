...
def scriptsToApprove = [
  'jobs/pipeline/testKenImage.groovy',
  'jobs/pipeline/pg_report.groovy',
  'jobs/BuildKenAndPushToECR.groovy',
  'jobs/deploy_elk.groovy',
  'jobs/deploy.groovy',
  'jobs/PR_job.groovy',
  'jobs/storage_cleanup.groovy',
  'jobs/testBuild.groovy'
]
