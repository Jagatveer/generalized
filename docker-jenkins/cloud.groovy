...
ecs_cluster_arn = System.getenv('ECS_CLUSTER_ARN') ?: "arn:aws:ecs:us-west-2:202279780353:cluster/jenkins-ecs"
aws_region = System.getenv('AWS_REGION') ?: 'us-west-2'
...
slave_image = System.getenv('SLAVE_IMAGE') ?: '202279780353.dkr.ecr.us-west-2.amazonaws.com/sandeep/jenkins:slave_v2'
